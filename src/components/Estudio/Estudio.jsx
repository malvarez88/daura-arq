              ...
              >
                ...
                >
                  ...
                  <p className="general-text">
                    ...
                    lugar, para la búsqueda de oportunidades a través de un
                    flujo de recursos, colaboraciones y tiempo. Un proceso de
                    trabajo más que una forma de trabajar, basado en la
                    formulación de estrategias, observación, yuxtaposición de
                    información, práctica y conocimiento.
                  ...
                  <p className="general-text">
                    ...
                    redes de profesionales transdisciplinares orientada a
                    obtener el mejor resultado para un proyecto; y por ello
                    apostamos por la innovación abierta, la colaboración y
                    compartir conocimientos. Algunos de nuestros partners y
                    amigos son:
                  </p>
                ...
                >
                  <div className="noticia">
                    ...
                    <p className="general-text">
                      ...
                      Núria Ayala, especialistes en projectes esportius
                      aquàtics, han lliurat el document a la delegació del club,
                      formada pel president Jordi Martín, la vicepresidenta
                ...
                >
                  <p className="general-text">
                    ...
                    investigación. Trabajamos en las áreas de arquitectura,
                    diseño de interiores, las intervenciones en sitios
                    históricos, el diseño urbano y planificación, paisaje,
                    exposiciones efímeras, la teoría y la crítica. Con sede en
                    Barcelona, hemos ido ampliando nuestro campo de acción,
                    estando ya involucrado en algunos proyectos internacionales.
                  </p>
